...
4. After contact click succeeds, directly paste the target message content.
...
- Contact selection must follow this priority:
  ...
  - If using grid click, use upper-half click point (`offset_ratio` around `0.22`) to avoid lower rows.
